...
\begin{enumerate}
    ...
    \item From the weak word, till the end of commands, Alexa will record the speech and partially sends it to Amazon's servers to be analyzed;
    \item Amazon will process the audio and breaks the command into individual sounds. It then consults a database containing various words pronunciations to find which words most closely 			correspond to the combination of the individual sounds.
\end{enumerate}
